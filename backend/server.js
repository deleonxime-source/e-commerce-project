...
export async function initDatabase() {
  ...
  const starterProducts = [
    ...
    },
    {
      ...
      size_quantities: { XS: 1, S: 7, M: 10, L: 12, XL: 8 },
    },
    {
      id: 4,
    ...
    },
    {
      ...
      name: 'Sleveless Tank',
      category_name: 'shirt',
      description: 'Black sleveless tank with metal detailing.',
      price: 55.99,
      image_url: '/images/products/product-6.jpg',
      image_urls: ['/images/products/product-6.jpg'],
      size_quantities: { XS: 12, S: 9, M: 10, L: 9, XL: 8 },
    },
    {
      id: 7,
      name: 'Black Calendar Tee Shirt',
      category_name: 'shirt',
      description: 'Block print tee shirt.',
      price: 85.99,
      image_url: '/images/products/product-7.jpg',
      image_urls: ['/images/products/product-7.jpg'],
      size_quantities: { XS: 10, S: 9, M: 15, L: 9, XL: 5 },
    },
     {
      id: 8,
      name: 'Black Tie-Front Tank',
      category_name: 'shirt',
      description: 'Black tank with tie front detailing.',
      price: 70.99,
      image_url: '/images/products/product-8.jpg',
      image_urls: ['/images/products/product-8.jpg'],
      size_quantities: { XS: 5, S: 13, M: 8, L: 12, XL: 4 },
    },
    {
      id: 9,
      ...
      image_urls: ['/images/products/product-9.jpg'],
      size_quantities: { XS: 3, S: 8, M: 10, L: 6, XL: 9 },
    },
    {
    id: 10,
      name: 'Sheer Zip Up Jacket',
      category_name: 'outerwear',
      description:'Black sheer jacket with zip up front closure.',
      price: 150.99,
      image_url: '/images/products/product-10.jpg',
      image_urls: ['/images/products/product-10.jpg'],
      size_quantities: { XS: 10, S: 7, M: 12, L: 6, XL: 8},
    },
    {
    id: 11,
      name: 'Leather Vest',
      category_name: 'outerwear',
      description:'Black leather jacket vest zip up front closure.',
      price: 150.99,
      image_url: '/images/products/product-11.jpg',
      image_urls: ['/images/products/product-11.jpg'],
      size_quantities: { XS: 10, S: 7, M: 12, L: 6, XL: 8},
  },
  {
          id: 12,
      ...
      image_urls: ['/images/products/product-12.jpg'],
      size_quantities: { XS: 15, S: 20, M: 15, L: 13, XL: 8},
},
{
          id: 13,
      ...
      image_urls: ['/images/products/product-13.jpg'],
      size_quantities: { XS: 21, S: 5, M: 13, L: 9, XL: 12},
},
{
          id: 14,
      name: 'Cropped Leather Jacket',
      category_name: 'outerwear',
      description:'Leather jacket with a cropped fit.',
      price: 150.99,
      image_url: '/images/products/product-14.jpg',
      image_urls: ['/images/products/product-14.jpg'],
      size_quantities: { XS: 18, S: 21, M: 15, L: 3, XL: 15},
},
  {
          id: 15,
      ...
      image_urls: ['/images/products/product-15.jpg'],
      size_quantities: { XS: 11, S: 15, M: 5, L: 19, XL: 17},
},
{
          id: 16,
      name: 'X-Ray Graphic Print Pants',
      category_name: 'pants',
      description:'Pants with an x-ray graphic print.',
      price: 185.99,
      image_url: '/images/products/product-16.jpg',
      image_urls: ['/images/products/product-16.jpg'],
      size_quantities: { XS: 21, S: 5, M: 13, L: 9, XL: 12},
},
